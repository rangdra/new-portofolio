      ...
      <div className="mt-6 lg:mt-20">
        <div className="lg:w-1/2 w-full mb-12">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-justify">
            Saya Rangdra Pangestu, saat ini saya sedang berkuliah di salah satu
            universitas. Di waktu luang, saya fokus belajar tentang web
            development khususnya dibidang front-end. Tujuan saya adalah membuat
            aplikasi/web yang berguna dan berkontribusi pada proyek open source
            sambil menyelesaikan studi s1 saya . 😄
          </p>
        </div>
        <div className="lg:w-1/2 w-full mb-12">
          <h1 className="text-cyan-500 font-semibold mb-4 text-3xl">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-justify">
            ...
            deployment, dan pemeliharaan. masih banyak hal lain yang belum saya
            temui, dan saya siap mempelajarinya.
          </p>
        </div>
        {/* <div className="lg:w-1/2 w-full mb-12">
            <h1 className="text-cyan-500 font-semibold mb-4 text-3xl">
